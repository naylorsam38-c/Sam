#!/usr/bin/env python3
"""Manual, tailored capability test for APP-009 (Home Assistant).
...
def test_shopping_list(pw):
    ...
    results.append({
        "id": "CAP-009-01", "name": "To-do lists (shopping list)", "route": "/todo",
...
def test_automation(pw):
    ...
    verdict = "PROVEN" if persisted else "NOT VERIFIED"
    results.append({
        "id": "CAP-009-02", "name": "Automations & scenes", "route": "/config/automation/dashboard",
        "discovered_from": "screen",
        "live_test": {
...
def main():
    ...
    out = {"application": "APP-009", "capabilities_defined": True, "discovery_method": "app-derived",

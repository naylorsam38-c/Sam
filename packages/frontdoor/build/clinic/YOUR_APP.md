...
> Take bookings for my clinic and invoice people afterwards.

This is what was built from your eight answers, in plain English.

## What is in it

- **Service**. Holds: Name, Description, Duration minutes, Price, Deposit required, Deposit amount.
- **Contact**. Holds: Name, Email, Phone, Type, Payment terms days.
- **Appointment** — moves through Booked → Confirmed → Completed → Cancelled → No-show. Holds: Service, Customer, Staff member, Start, Notes, Deposit paid.
- **Invoice** — moves through Draft → Awaiting approval → Awaiting payment → Paid → Voided. Holds: Contact, Issue date, Due date, Reference, Notes, Sent at.
- **Invoice line**. Holds: Invoice, Description, Quantity, Unit amount.
- **Bill** — moves through Draft → Awaiting payment → Paid → Voided. Holds: Contact, Issue date, Due date, Amount, Reference.
- **Payment**. Holds: Invoice, Bill, Amount, Date, Method.

## Who can do what

- **Owner** — in charge; can do everything.
- **Staff** — can create, edit, view.
- **Admin** — in charge; can do everything.
- **Accountant** — can create, delete, edit, view.
- **Advisor** — can view.

## What it will tell you

- **Upcoming appointments** — What's booked for the coming days, per staff member?
- **No-show rate** — How often do customers fail to turn up?

## What it does on its own, with nobody clicking

- booking-frontdesk/OPS-001
- booking-frontdesk/OPS-002
- booking-frontdesk/OPS-003
- booking-frontdesk/OPS-004
- booking-frontdesk/OPS-005
- booking-frontdesk/OPS-006
- booking-frontdesk/OPS-007
- booking-frontdesk/OPS-008
- booking-frontdesk/OPS-009
- booking-frontdesk/OPS-010
- booking-frontdesk/OPS-011
- accounting-ledger/OPS-001
- accounting-ledger/OPS-002
- accounting-ledger/OPS-003
- accounting-ledger/OPS-004
- accounting-ledger/OPS-005
- accounting-ledger/OPS-006
- accounting-ledger/OPS-007
- accounting-ledger/OPS-008
- accounting-ledger/OPS-009
- accounting-ledger/OPS-010
...
- **Customer and Contact** — Both pieces you picked hold the same kind of person, under different names. They are one record, called Contact.
- **authority of Admin** — Admin was in charge of its own piece; you put Owner in charge, so Admin now has the same authority as Staff, and Owner assigns it.
...
- **B.03** — What you charge is one payment per appointment, at whatever price you set on each service inside the app. There are no subscriptions or plans.

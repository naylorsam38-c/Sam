...
> Run my small team's projects: tasks, who's doing what, and whether it's actually done.

This is what was built from your eight answers, in plain English.

## What is in it

- **Project**. Holds: Name, Description, Owner, Due date, Colour.
- **Task** — moves through To do → In progress → Done. Holds: Title, Description, Assignee, Due date, Priority, Project.
- **Comment**. Holds: Body, Task.

## Who can do what

- **Admin** — in charge; can do everything.
- **Member** — can create, delete, edit, view.
- **Guest** — can create, view.

## What it will tell you

- **Open tasks by person** — Who is carrying how much open work right now?
- **Overdue tasks** — What has slipped past its due date and needs chasing?
...
You picked **Console**. The other two are there anyway.
